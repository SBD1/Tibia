...
CREATE PROCEDURE public.unequip_weapon_from_left_hand(IN _id_player integer)
    LANGUAGE plpgsql
    AS $$
  DECLARE 
 	_mao_esq integer;
...
CREATE PROCEDURE public.unequip_weapon_from_right_hand(IN _id_player integer)
    LANGUAGE plpgsql
    AS $$
  DECLARE 
 	_mao_dir integer;
