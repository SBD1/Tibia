...
(2, 'Venore', DEFAULT), 
(2, 'Jakundaf Desert', DEFAULT), 
(2, 'Outlaw Camp', DEFAULT),
(2, 'Plains of Havoc', DEFAULT),
(2, 'Feyrist Mountains', true);

INSERT INTO localizacao (posicao_x, posicao_y, posicao_z, idregiao) VALUES 
(8, 10, 0, 6), 
(8, 11, 0, 6), 
(8, 12, 0, 6), 
(8, 8, 0, 6), 
...
INSERT INTO player (nome, vocacao, vida_maxima, vida_atual, mana_maxima, mana_atual, genero, experiencia, idpersonagem, "level", data_de_criacao) VALUES
('Druid Lcs', 'druida', 100, 100, 200, 200, 'masculino', 0, 21, 1, '25/07/2022'),
('Fer Cavaleiro', 'cavaleiro', 150, 150, 100, 100, 'masculino', 0, 22, 1, '25/07/2022'),
('Paladino Jose', 'paladino', 130, 130, 130, 130, 'masculino', 0, 23, 1, '25/07/2022'),
('Feiticeira Fer', 'feiticeiro', 100, 100, 200, 200, 'feminino', 0, 24, 1, '25/07/2022'),
('Mariana Cavaleira', 'cavaleiro', 150, 150, 100, 100, 'feminino', 0, 25, 1, '25/07/2022'),
('Larrissa Druida', 'druida', 100, 100, 200, 200, 'feminino', 0, 26, 1, '25/07/2022');
...
INSERT INTO inventario (look_corpo, look_cabeca, look_pernas, look_pes, look_costas, mao_dir, mao_esq, fonte_de_luz, capacidade, idplayer, nomeplayer) VALUES
(null, null, null, null, 7, 1, null, null, 410, 1, 'Druid Lcs'),
(null, null, null, null, 8, 2, null, null, 410, 2, 'Fer Cavaleiro'),
(null, null, null, null, 9, 3, null, null, 410, 3, 'Paladino Jose'),
(null, null, null, null, 10, 4, null, null, 410, 4, 'Feiticeira Fer'),
(null, null, null, null, 11, 5, null, null, 410, 5, 'Mariana Cavaleira'),
(null, null, null, null, 12, 6, null, null, 410, 6, 'Larrissa Druida');
